...
class CookieGetter {
    getCookie(url, endUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const elem = yield Promise.race([page.waitForSelector('input[type="email"]'), page.waitForSelector('input[type="username"]'), page.waitForSelector('input[type="text"]')]);
            ...
            if (!!isHidden && isHidden !== null) {
                try {
                    ...
                    const buttonLocator = yield Promise.race([page.waitForSelector('text="Next"'), page.waitForSelector('text="Submit"'), page.waitForSelector('text="Yes"'), page.waitForSelector('text="Login"'), page.waitForSelector('text="Yes"')]);
                    //@ts-ignore
                    yield buttonLocator.click({ waitUntil: 'networkidle' });
                }
            }
            while (!!isHidden) {
                yield sleep_promise_1.default(2000);
