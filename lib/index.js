    ...
    return function (_req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!process.env.UI5_MIDDLEWARE_ONELOGIN_LOGIN_URL) {
                ...
                const cookieObj = yield new cookieGetter_1.default().getCookie(process.env.UI5_MIDDLEWARE_ONELOGIN_LOGIN_URL);
            ...
            cookies
                ...
                if (!process.env.UI5_MIDDLEWARE_HTTP_HEADERS) {
                    cookieStr = cookieStr.concat(cookieStr, cookie_1.serialize(cookie.name, cookie.value, cookie), '; ');
                }
            });
            if (!process.env.UI5_MIDDLEWARE_HTTP_HEADERS) {
